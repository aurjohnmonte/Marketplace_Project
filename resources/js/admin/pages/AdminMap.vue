    ...
    <div style="top: 0; bottom: 0;">
        ...
        <div class="map-navbar" v-if="show_nav">
            <div style="display: flex; flex-direction: row; align-items: center; justify-content: end;">
                <input type="text" placeholder="Search Shop" style="margin: 10px;" v-model="search_text" class="input-btn">
...
export default {
    ...
    methods: {
                    ...
                    .on('popupopen', () => {
                        ...
                        if (btn) {
                            btn.addEventListener("click", () => {
                                console.log('clicked');
                                this.$router.push({name: 'SellerProfile', params: {'id': shop.user_id}});
                            });
                        }
        ...
        async returnAllShops(){
            ...
            const res = await axios.get('/admin/return-all/shops');
